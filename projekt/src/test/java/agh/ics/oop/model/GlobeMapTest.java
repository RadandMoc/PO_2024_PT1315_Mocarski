...
class GlobeMapTest {
    ...
    public void moveTestForGlobeMap(){
        ...
        final List<Byte> directions2 = Arrays.asList(
                (byte)0
        );
        final List<Byte> directions3 = Arrays.asList(
                (byte)3
        );
        final List<Byte> directions4 = Arrays.asList(
                (byte)7
        );
    ...
    public void moveTestIfAnimalGoToAnotherSideGlobeMap(){
        ...
        Animal a1 = new Animal(new Vector2d(0,10), 100, 0,directions1);
        Animal a2 = new Animal(new Vector2d(19,10), 100, 0,directions2);
        Animal a3 = new Animal(new Vector2d(0,10), 100, 0,directions3);
        Animal a4 = new Animal(new Vector2d(19,10), 100, 0,directions4);
    ...
    public void moveTestMoveWithinBoundariesGlobeMap(){
        ...
        Animal a1 = new Animal(new Vector2d(10,10), 100, 0,directions1);
        map.place(a1);
    ...
    public void consumeTest(){
        ...
        Animal animal1 = new Animal(pos1, 100, 0, new ArrayList<>());
        Animal animal2 = new Animal(pos2, 100, 0, new ArrayList<>());
        Animal animal3 = new Animal(pos3, 100, 0, new ArrayList<>());
        ...
        //then
        assertEquals(80,animal1.getEnergy());
        assertEquals(80,animal2.getEnergy());
        assertEquals(80,animal3.getEnergy());
